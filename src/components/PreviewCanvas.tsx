...
import { Download, Maximize2, RotateCcw, RotateCw } from "lucide-react";
      ...
      <div className="bg-white border-b border-gray-200 p-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className={
              showComparison ? "bg-blue-50 border-blue-300 text-blue-700" : ""
            }
          >
            Before/After
          </Button>
          ...
          <div className="h-4 w-px bg-gray-300" />
          <ZoomControls onValueChange={setZoomValue} />
          <div className="h-4 w-px bg-gray-300" />
          <Button variant="ghost" size="sm">
